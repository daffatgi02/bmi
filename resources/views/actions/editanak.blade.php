                            ...
                            <div class="row">
                                <div class="col-12 col-lg-6">
                                    ...
                                    <select class="form-select mb-3" aria-label="Default select example" name="jk"
                                        id="jk">
                                        <option disabled value="" {{ old('jk', $danaks->jk) ? '' : 'selected' }}>Pilih
                                            Jenis Kelamin
                                        </option>
                                        <option value="L" {{ old('jk', $danaks->jk) === 'L' ? 'selected' : '' }}>
                                            Laki-Laki
                                        </option>
                                        <option value="P" {{ old('jk', $danaks->jk) === 'P' ? 'selected' : '' }}>Wanita
                                        </option>
                                    </select>
                                    ...
                                    {{-- Select Posyandu --}}
                                    <select class="form-select mb-3" aria-label="Default select example" name="t_posyandu"
                                        id="t_posyandu">
