                        ...
                        <div class="card-body">
                            <form action="{{ route('dbulanans.update', $dbulanans->id) }}" method="POST"
                                ...
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" id="umur_periksa" name="umur_periksa"
                                        placeholder="Masukkan Umur" value="{{ $dbulanans->umur_periksa }}" required
                                        readonly>
                                    <label for="floatingInput" class="fw-bold">Umur:</label>
                                </div>
                                <div class="form-floating mb-3">
                                    <input type="number" class="form-control" id="bb_anak_input" name="bb_anak"
                                        placeholder="Masukkan Berat Badan (KG)" value="{{ $dbulanans->bb_anak }}" required>
                                    <label for="bb_anak_input" class="fw-bold">Berat Badan (KG):</label>
                                </div>
                                <div class="form-floating mb-3">
                                    <input type="number" class="form-control" id="tb_anak_input" name="tb_anak"
                                        placeholder="Masukkan Tinggi Badan (CM)" value="{{ $dbulanans->tb_anak }}" required>
                                    <label for="tb_anak_input" class="fw-bold">Tinggi Badan (CM):</label>
                                </div>
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" id="lk_anak" name="lk_anak"
                                ...
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" id="ll_anak" name="ll_anak"
                                ...
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" id="st_anak" name="st_anak"
                                        placeholder="Status Anak" value="{{ $dbulanans->st_anak }}" required readonly>
                                ...
                                <div class="d-none">
                                    ...
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control" id="updated_at" name="updated_at"
                                            placeholder="Masukkan updated" value="{{ $dbulanans->updated_at }}" required>
